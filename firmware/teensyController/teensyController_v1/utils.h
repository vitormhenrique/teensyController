...
extern BounceDescriptor buttons[];
...
void setupDigitalButtons(){
	...
	buttons[19].attach(CHF);
	buttons[19].setDescriptor("CHF"); 
	pinMode(CHE,INPUT);
	pinMode(CHD,INPUT);
